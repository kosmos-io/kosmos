...
function node_reset() {
    echo "exec node_reset(1/5): stop kubelet...."
    systemctl stop kubelet

    echo "exec node_reset(2/5): remove container of kubernetes...."
