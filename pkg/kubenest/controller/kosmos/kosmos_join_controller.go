...
import (
	...
	"github.com/kosmos.io/kosmos/pkg/kubenest/manifest/kosmos"
...
func (c *KosmosJoinController) UninstallClusterTree(ctx context.Context, request reconcile.Request, vc *v1alpha1.VirtualCluster) error {
	...
	clustertreeDeploy, err := kosmosctl.GenerateDeployment(kosmos.ClusterTreeClusterManagerDeployment, DeploymentReplace{
	...
	clustertreeSecret, err := kosmosctl.GenerateSecret(kosmos.ClusterTreeClusterManagerSecret, kosmos.SecretReplace{
		Namespace: request.Namespace,
