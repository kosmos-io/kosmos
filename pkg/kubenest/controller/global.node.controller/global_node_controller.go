...
func isProtectNode(node *v1.Node) bool {
	roles := []string{utils.LabelNodeRoleOldControlPlane, utils.LabelNodeRoleControlPlane, util.GetVirtualControllerLabel()}
