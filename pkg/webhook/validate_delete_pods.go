...
func (v *PodValidator) Handle(ctx context.Context, req admission.Request) admission.Response {
	...
	// if the node is a kosmos node and is in the NotReady state,
	// and the requested username is in the list of usernames that need to be prevented from deletion,
