...
const (
	Replicas                                  = 1
	ControllerImageName                       = "nexus.cmss.com:8086/cmss/kube-controller-manager:v1.26.12"
	SchedulerImageName                        = "nexus.cmss.com:8086/cmss/scheduler:v0.2.0"
...
func getVirtualClusterSchedulerConfigMapManifest(name, namespace string) (*v1.ConfigMap, error) {
	virtualClusterSchedulerConfigMapBytes, err := util.ParseTemplate(VirtualClusterSchedulerOldConfigMap, struct {
