		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"nodeType": {
						SchemaProps: spec.SchemaProps{
							Description: "NodeType declares the type for scheduling node. Valid options are \"host\", \"leaf\", \"mix\".",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"namespacePrefix": {
						SchemaProps: spec.SchemaProps{
							Description: "NamespacePrefix the prefix of the target resource namespace",
							Type:        []string{"string"},
							Format:      "",
						},
					},
