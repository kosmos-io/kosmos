...
type Interface interface {
	...
	// VirtualPlanes returns a VirtualPlaneInformer.
	VirtualPlanes() VirtualPlaneInformer
}
...
// VirtualPlanes returns a VirtualPlaneInformer.
func (v *version) VirtualPlanes() VirtualPlaneInformer {
	return &virtualPlaneInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
